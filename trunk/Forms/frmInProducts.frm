...
Begin VB.Form frmInProducts 
   ...
   End
End
Attribute VB_Name = "frmInProducts"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim CURR_COL As Integer
Dim rsInProducts As New Recordset
...
Private Sub cmdProses_Click()
    ...
    'Else
        'rsInProducts.Close
        Set rsInProducts = Nothing
        With SQLParser
            .Fields = "*"
            .Tables = "QR_IN_STOCKS"
            '.wCondition = " Format(DateAdded,'MM/dd/yyyy') >=#" & cbMonth1.Text & "/" & cbDay1.Text & "/" & cbYear1.Text & "# " & _
                          "AND Format(DateAdded,'MM/dd/yyyy') <=#" & cbMonth2.Text & "/" & cbDay2.Text & "/" & cbYear2.Text & "# "
            ...
            '              "AND Format(DateAdded,'mm/dd/yyyy') <=#" & Format(DTPicker2.Value, "mm/dd/yyyy") & "# "
             .wCondition = "(((QR_IN_STOCKS.DateAdded)>='" & Format(DTPicker1.Value, "mm/dd/yyyy") & "' And (QR_IN_STOCKS.DateAdded)<='" & Format(DTPicker2.Value, "mm/dd/yyyy") & "'))"
            .SortOrder = " DateAdded ASC,ProductCode ASC"
            .SaveStatement
        End With
    
        rsInProducts.CursorLocation = adUseClient
        rsInProducts.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
        
        With RecordPage
            .Start rsInProducts, 10000
            FillList 1
        End With
        rsInProducts.Close
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsInProducts, RecordPage.PageStart, RecordPage.PageEnd, 9, 2, False, True, , , , "PK")
    Me.Enabled = True
