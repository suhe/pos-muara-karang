...
Private Sub cmdOk_Click()
    ...
    If CurrBiz.BUSINNES_SALE = 1 Then
        ...
        Select Case cmbOperation(2).Text
            ...
            Case "Lunas Debitor dan Kreditor": strFilter = strFilter & " flag_debitor=1 AND flag_kreditor=1 "
            Case "Lunas Kreditor": strFilter = strFilter & " flag_debitor=0 AND flag_kreditor=1 "
            Case "Lunas Debitor": strFilter = strFilter & " flag_debitor=0 AND flag_kreditor=0"
            Case "Hutang Debitor dan Kreditor": strFilter = strFilter & " flag_debitor=0 AND flag_kreditor=0"
            Case "Hutang Kreditor": strFilter = strFilter & " flag_debitor=1 AND flag_kreditor=0 "
            Case "Hutang Debitor": strFilter = strFilter & " flag_debitor=0 AND flag_kreditor=1"
        End Select
    End If
