    ...
    End If
     ...
     If Option2.Value = True Then
        If txtFilter(0).Text <> "" Or chTanggal.Value = 1 Then
            strFilter = strFilter & " AND"
        End If
        tbl.TABLE_SEARCH_FLAG = flag & "=0 "
        tbl.TABLE_SEARCH_FLAG_2 = flag & "=0 "
        tbl.TABLE_SEARCH_FLAG_3 = flag & "=0 "
        
        If srcform.Name = "frmKomisi" Then
            strFilter = strFilter & " " & flag & "=0 AND j.flag_kreditor=1 "
        Else
            strFilter = strFilter & " " & flag & "=0 "
        End If
    End If
    'MsgBox strFilter
