...
Begin VB.Form frmSelectBankPurchase 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Bank Purchase"
   ClientHeight    =   7665
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14445
   ...
   End
End
Attribute VB_Name = "frmSelectBankPurchase"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim CURR_COL As Integer
Dim rsPurchaseBank As New Recordset
...
Private Sub cmdProses_Click()
    ...
    'Else
        With SQLParser
            .Fields = "*"
            .Tables = "QR_PURCHASE_BANKS"
            .wCondition = "(((QR_PURCHASE_BANKS.DateAdded)>='" & Format(DTPicker1.Value, "mm/dd/yyyy") & "' And (QR_PURCHASE_BANKS.DateAdded)<='" & Format(DTPicker2.Value, "mm/dd/yyyy") & "') AND ((QR_PURCHASE_BANKS.BankCode)=" & CurrBiz.BUSINNES_BANK & "))"
        ...
        rsPurchaseBank.CursorLocation = adUseClient
        rsPurchaseBank.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
        
        With RecordPage
            .Start rsPurchaseBank, 75
            FillList 1
        End With
        rsPurchaseBank.Close
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsPurchaseBank, RecordPage.PageStart, RecordPage.PageEnd, 9, 2, False, True, , , , "PK")
    Me.Enabled = True
