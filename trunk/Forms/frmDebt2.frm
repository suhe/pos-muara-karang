...
Begin VB.Form frmDebt2 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Debt Details Faktur"
   ClientHeight    =   8265
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13725
   ...
   End
End
Attribute VB_Name = "frmDebt2"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim CURR_COL As Integer
Dim rsDebt As New Recordset
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "*"
        .Tables = "QR_DEBTS"
        .wCondition = "SUPPLIERID='" & frmDebt.lvList.SelectedItem.Text & "'"
        .SaveStatement
    End With

    rsDebt.CursorLocation = adUseClient
    rsDebt.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsDebt, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "PK")
    Me.Enabled = True
...
Private Sub Browsesrcform()
    Dim a As Double
    With frmDebtDetails
        a = FormatNumber(lvList.SelectedItem.SubItems(7), True, True, True)
        If (a = 0) Then
            .cmdPayment.Enabled = False
            .cmdPayment.Caption = "Lunas"
        End If
        .show vbModal
    End With
End Sub
