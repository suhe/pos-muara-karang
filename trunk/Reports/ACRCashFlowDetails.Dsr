VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ACRCashFlowDetails 
   Caption         =   "Laporan Cash Flow Details"
   ClientHeight    =   7710
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   ControlBox      =   0   'False
   Icon            =   "ACRCashFlowDetails.dsx":0000
   MDIChild        =   -1  'True
   WindowState     =   2  'Maximized
   _ExtentX        =   26882
   _ExtentY        =   13600
   SectionData     =   "ACRCashFlowDetails.dsx":038A
End
Attribute VB_Name = "ACRCashFlowDetails"
