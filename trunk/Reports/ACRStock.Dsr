VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ACRStock 
   Caption         =   "Report Stok  Obat"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   Icon            =   "ACRStock.dsx":0000
   MDIChild        =   -1  'True
   _ExtentX        =   26882
   _ExtentY        =   19420
   SectionData     =   "ACRStock.dsx":038A
End
Attribute VB_Name = "ACRStock"
