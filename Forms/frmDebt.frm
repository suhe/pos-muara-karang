...
Begin VB.Form frmDebt 
   Caption         =   "Hutang Kreditor"
   ClientHeight    =   4380
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7950
   Icon            =   "frmDebt.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   4380
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.ComboBox cbSortType 
         Height          =   315
         ItemData        =   "frmDebt.frx":038A
         Left            =   6720
         List            =   "frmDebt.frx":0394
         TabIndex        =   8
         Text            =   "ASC"
         Top             =   30
         Width           =   855
      ...
      Begin VB.ComboBox cbSort 
         Height          =   315
         ItemData        =   "frmDebt.frx":03A3
         Left            =   5160
         List            =   "frmDebt.frx":03AD
         TabIndex        =   7
         Text            =   "ID Kreditor"
         Top             =   30
         Width           =   1575
      ...
      Begin VB.ComboBox cbShow 
         Height          =   315
         ItemData        =   "frmDebt.frx":03CD
         Left            =   4020
         List            =   "frmDebt.frx":03CF
         TabIndex        =   6
         Text            =   "30"
         Top             =   30
         Width           =   735
   ...
   End
End
Attribute VB_Name = "frmDebt"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim rsDebtKreditor As New Recordset
            ...
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    With lvList
                        ...
                        tbl.TABLE_NM_KREDITUR = .SelectedItem.SubItems(1)
                        tbl.TABLE_ALMT_KREDITUR = .SelectedItem.SubItems(2)
                        tbl.TABLE_TLP_KREDITOR = .SelectedItem.SubItems(3)
                        tbl.TABLE_KOTA_KREDITUR = .SelectedItem.SubItems(4)
                        tbl.TABLE_CP_KREDITOR = .SelectedItem.SubItems(5)
                    End With
                        frmDebtDetails.show vbModal
                End If
             End If
        Case "Search"
            With frmSearch
...
Private Sub Form_Activate()
    HighlightInWin Me.Name: MDIMainMenu.ShowTBButton "fttftft"
End Sub
...
Private Sub Form_Load()
    ...
    Select Case cbSort.Text
        Case "ID Kreditor": sort = "ABS(j.id_kreditor) " & cbSortType.Text
