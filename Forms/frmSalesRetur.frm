...
Begin VB.Form frmSalesRetur 
   ...
   Begin VB.Frame fraSearch 
      ...
      Begin VB.ComboBox cboFilter 
         Height          =   315
         ItemData        =   "frmSalesRetur.frx":0000
         Left            =   240
         List            =   "frmSalesRetur.frx":0002
      ...
      Begin VB.Image imgSearch 
         Height          =   480
         Left            =   3960
         Picture         =   "frmSalesRetur.frx":0004
         Top             =   120
         Width           =   480
      End
   End
   ...
   Begin MSComctlLib.ImageList i32x32 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalesRetur.frx":08CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalesRetur.frx":15A8
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalesRetur.frx":18F1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalesRetur.frx":4020
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalesRetur.frx":59B2
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalesRetur.frx":8BEB
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalesRetur.frx":94C5
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Image imgQty 
      Height          =   480
      Left            =   6240
      Picture         =   "frmSalesRetur.frx":AE57
      Top             =   4080
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image imgIcon 
      Height          =   480
      Left            =   120
      Picture         =   "frmSalesRetur.frx":BA9B
      Top             =   3840
      Visible         =   0   'False
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmSalesRetur"
...
Dim rsreturSalesCashier    As New Recordset
Public PK      As Long
...
Private Sub cmdProcess_Click()
 ...
 'If (payment >= ptotal) Then
        With rsreturSalesCashier
            ...
            'Next i
             sql = "UPDATE DETAILS_SALES SET qty_retur=" & txtRetur.Text & ",total_retur=" & Val(txtRetur.Text * lblPriceP.Caption) & " WHERE FakNo='" & txtFak.Text & "' AND productCode='" & lblCode.Caption & "'"
            'MsgBox sql
            CN.Execute sql
...
Private Sub Form_Load()
    ...
    rs.Open "SELECT * FROM HEAD_SALES WHERE PK=" & PK, CN, adOpenStatic, adLockOptimistic
    Dim FAK As String
    FAK = txtFak.Text
    rsdetails.Open "SELECT * FROM DETAILS_SALES WHERE PK=" & PK, CN, adOpenStatic, adLockOptimistic
    rsreturSalesCashier.Open "SELECT * FROM DETAILS_SALES WHERE PK=" & PK, CN, adOpenStatic, adLockOptimistic
    cboFilter.Text = "Code"
    'lblCodeCust.Caption = "CUS-00000"
    'lblNamaCust.Caption = "UMUM"
    'lblDiscPelanggan.Caption = "N"
...
Private Sub lvList_DblClick()
    ...
    Else
        Call callBrand
        'frmSalesReturAE.txtQty.SetFocus
        'frmSalesReturAE.show vbModal
    End If
End Sub

Private Sub callBrand()
    'With frmSalesReturAE
...
Private Sub txtAmount_KeyPress(KeyAscii As Integer)
    NumberOnly KeyAscii
    If KeyAscii = 13 Then
        If txtAmount.Text = "" Then MsgBox "Empty Retur Qty Expedition", vbOKOnly + vbCritical: Exit Sub
        Call counttotal
    End If
End Sub
...
Private Sub txtRetur_KeyPress(KeyAscii As Integer)
    ...
    NumberOnly KeyAscii
    If KeyAscii = 13 Then
        If txtRetur.Text = "0" Then MsgBox "Zero Retur Qty Retur", vbOKOnly + vbCritical: Exit Sub
        'Call counttotal
        If txtRetur.Text = "" Then MsgBox "Empty Retur", vbOKOnly + vbCritical: Exit Sub
        'If txtDisc.Text = "" Then MsgBox "Empty Discount", vbOKOnly + vbCritical: Exit Sub
        
        If Val(txtRetur.Text) <= Val(lblQty.Caption) Then
            MsgBox "Qty Retur Is Valid", vbOKOnly + vbQuestion
            'txtPayment.Text = Format(Val(lblPriceP.Caption) * Val(txtRetur.Text), "##,###0.00")
            Dim total As Double
            Dim qty As Integer
            Dim totalAll As Double
            
            total = FormatNumber(lblPriceP.Caption, 0)
            'MsgBox total
            qty = txtRetur.Text
            'MsgBox qty
            totalAll = total * qty
            'MsgBox totalAll
            txtPayment.Text = Format(totalAll, "##,###0.00")
        Else
...
Private Sub txtSrchStr_Change()
    ...
    If txtSrchStr.Text <> "" Then
        With SQLParser
            .Fields = "PK,ProductCode,ProductName,Price_sell,Discount,Stock"
